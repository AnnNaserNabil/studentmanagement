...
<body>
	...
	<nav>
		<label class="logo">Global University</label>

		<ul>
			<li><a href="Form.php">Admission Form</a></li>
			<li><a href="Academic.php">Courses</a></li>
    ...
    <div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<img class="welcome_img" src="gettyimage.jpg">
...
<div class="adm_int">
			...
			<textarea class="label_txt" name="message"></textarea>
